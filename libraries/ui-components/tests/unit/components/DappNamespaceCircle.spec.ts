...
describe("DappNamespaceCircle -->", () => {
  let widget: Wrapper<Vue>;
  beforeEach(() => {
    widget = shallowMount(DappNamespaceCircle as any, componentOptions);
  });
  ...
  it("should render correct elements with correct attributes and values", () => {
