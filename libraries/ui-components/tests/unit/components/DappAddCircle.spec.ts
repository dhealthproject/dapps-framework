...
describe("DappAddCircle -->", () => {
  let widget: Wrapper<Vue>;
  beforeEach(() => {
    widget = shallowMount(DappAddCircle as any, componentOptions);
  });
  ...
  it("should display correct elements with correct attributes & classes", () => {
    ...
    const rectElements = gElement.findAll("rect");
    ...
    expect(svgElement.classes()).to.include("dappAddCircle-circle-icon");
    ...
    expect(rectElements.length).to.equals(2);
    expect(rectElements.at(0).attributes().x).to.equals("17");
    expect(rectElements.at(0).attributes().y).to.equals("11");
    expect(rectElements.at(0).attributes()["fill-rule"]).to.equals("evenodd");
    expect(rectElements.at(0).attributes()["clip-rule"]).to.equals("evenodd");
    expect(rectElements.at(0).attributes().fill).to.equals("#FFFFFF");
    expect(rectElements.at(0).attributes().width).to.equals("4");
    expect(rectElements.at(0).attributes().height).to.equals("16");
    expect(rectElements.at(1).attributes().x).to.equals("11");
    expect(rectElements.at(1).attributes().y).to.equals("17");
    expect(rectElements.at(1).attributes()["fill-rule"]).to.equals("evenodd");
    expect(rectElements.at(1).attributes()["clip-rule"]).to.equals("evenodd");
    expect(rectElements.at(1).attributes().fill).to.equals("#FFFFFF");
    expect(rectElements.at(1).attributes().width).to.equals("16");
    expect(rectElements.at(1).attributes().height).to.equals("4");
  });
});
