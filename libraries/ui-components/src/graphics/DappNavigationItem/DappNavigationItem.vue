...
<template>
  <div
    :class="{
      'dappNavigationItem-base': true,
      'dappNavigationItem-style-primary': variant == 'primary',
      'dappNavigationItem-style-secondary': variant == 'secondary',
      'dappNavigationItem-style-tertiary': variant == 'tertiary',
    }"
    @click="$emit('click')"
  >
    <div class="dappNavigationItem-mainDiv">
      <DappIcon :src="icon" size="medium-small" />
      <span>{{ label }}</span>
    </div>
  </div>
</template>

<script lang="ts" src="./DappNavigationItem.ts"></script>

<style lang="postcss" scoped>
@import "./DappNavigationItem.scss";
</style>
