 ...
 * objects passed as **inputs** to {@link Welcome} instances.
 * <br /><br />
 * Use this interface whenever you are *using the `Welcome`* contract.
 * <br /><br />
 * Following *inputs* apply to the {@link Welcome} contract class:
...
export interface WelcomeParameters extends ContractParameters {
   ...
   * <br /><br />
   * Note that the welcome message is *optional* in the {@link Welcome}
   * contract and may be omitted.
   *
   * @access public
   * @example `"Welcome to my cool dApp!"`
   * @var {string}
   */
  message?: string;
}
 ...
 * *welcome* contract which is used to discover operations
 * of welcoming new users in the dApp.
 * <br /><br />
 * Use this class whenever you are interpreting an operation of
 * welcome for your dApp. Also, an instance of this class is created
 * using {@link Factory.createFromJSON} given a contract signature
 * that matches: `/:welcome$/` (ends with).
 * <br /><br />
 * #### Parameters
 * Following *inputs* apply to the {@link Welcome} contract class:
 * | Input | Type | Required? | Description |
 ...
 * const contract: Welcome = new Welcome({
...
export class Welcome extends Contract {
  /**
   * Construct a **welcome** contract. Note that some of
   * the **inputs are required**.
   * <br /><br />
   * The welcome contract *requires* inputs including the `dappIdentifier`
   * for the operation, refer to the above [parameters](#parameters)
  ...
  public constructor(
     ...
     * @var {EarnParameters}
     */
    protected inputs: WelcomeParameters,
   ...
   * the **body** of the contract, e.g. in the {@link Welcome} contract
   * the body *may* contain a *message*.
   * <br /><br />
   * In the welcome contract, an optional `message` may be included but
   * it is not required.
   * field.
   * <br /><br />
  ...
  public get body(): ObjectLiteral {
    ...
    const fields: ObjectLiteral = {
      message:
        this.inputs.message ?? `Welcome to ${this.inputs.dappIdentifier}`,
    };
