...
import { PrepareBoost10Payouts } from "../../../../../src/payout/schedulers/BoosterPayouts/PrepareBoost10Payouts";

describe("payout/PrepareBoost5Payouts", () => {
  let command: PrepareBoost10Payouts;
  ...
  beforeEach(async () => {
    ...
    command = module.get<PrepareBoost10Payouts>(PrepareBoost10Payouts);
  ...
  describe("get command()", () => {
    it("should return correct result", () => {
      ...
      // assert
      expect(result).toBe("PrepareBoost10Payouts");
    });
  });
  ...
  describe("runAsScheduler()", () => {
    it("should call correct methods and run correctly", async () => {
      ...
      // assert
      expect(loggerSetModuleCall).toHaveBeenNthCalledWith(1, "payout/PrepareBoost10Payouts");
      expect(debugLogCall).toHaveBeenNthCalledWith(1, `Starting payout preparation for booster type: boost10`);
      expect(debugLogCall).toHaveBeenNthCalledWith(2, `Total number of boost10 payouts prepared: "0"`);
