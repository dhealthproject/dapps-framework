...
export class OnAuthOpened {
   ...
   * @returns {OnAuthOpened}   The prepared event (which can be emitted).
   */
  public static create(challenge: string): OnAuthOpened {
    // creates instance and fill
    const event = new OnAuthOpened();
