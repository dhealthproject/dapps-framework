 ...
 * @since v0.4.0
 */
export type PrepareBoost5PayoutsCommandOptions =
  PrepareBoosterPayoutsCommandOptions;

/**
 * @label PAYOUT
 * @class PrepareBoost5Payouts
 * @description The implementation for the payout *preparation*
 * scheduler. Contains source code for the execution logic of a
 * command with name: `processor:PrepareBoost5Payouts`.
 * <br /><br />
 ...
 */
@Injectable()
export class PrepareBoost5Payouts extends PrepareBoosterPayouts {
  /**
  ...
  public async runAsScheduler(): Promise<void> {
    ...
    this.debugLog(`Starting payout preparation for booster type: boost5`);

    // display debug information about total number of transactions
    this.debugLog(
      `Total number of boost5 payouts prepared: "${this.totalNumberPrepared}"`,
    );
