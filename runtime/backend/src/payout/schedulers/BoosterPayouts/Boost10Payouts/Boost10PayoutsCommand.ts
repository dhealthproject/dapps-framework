...
import { BroadcastBoost10Payouts } from "./BroadcastBoost10Payouts";
...
@Module({
  ...
  providers: [PrepareBoost10Payouts, BroadcastBoost10Payouts],
  exports: [PrepareBoost10Payouts, BroadcastBoost10Payouts],
})
export class Boost10PayoutsCommand {}
