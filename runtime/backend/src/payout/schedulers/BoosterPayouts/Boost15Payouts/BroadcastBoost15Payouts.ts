...
/**
 * @interface BroadcastBoost15PayoutsCommandOptions
 ...
 * @since v0.4.0
 */
export type BroadcastBoost15PayoutsCommandOptions =
  BroadcastBoosterPayoutsCommandOptions;

/**
 * @label PAYOUT
 * @class BroadcastBoost15Payouts
 * @description The implementation for the payout *preparation*
 * scheduler. Contains source code for the execution logic of a
 * command with name: `processor:BroadcastBoost15Payouts`.
 * <br /><br />
 ...
 */
@Injectable()
export class BroadcastBoost15Payouts extends BroadcastBoosterPayouts {
  /**
  ...
  protected get boosterAsset(): AssetParameters {
    return this.configService.get<AssetParameters>("boosters.referral.boost15");
  }
  ...
  protected get command(): string {
    return `BroadcastBoost15Payouts`;
  }
  ...
  public async runAsScheduler(): Promise<void> {
    ...
    this.debugLog(`Starting payout broadcast for booster type: boost15`);
    ...
    await this.run([this.collection], {
      ...
      debug: true,
    } as BroadcastBoost15PayoutsCommandOptions);
  }
}
