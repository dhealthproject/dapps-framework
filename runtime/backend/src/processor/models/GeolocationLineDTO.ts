 ...
 * @since v0.3.2
 */
export class GeolocationLineDTO extends GeolocationDTO {
  /**
  ...
  @ApiProperty({
    ...
    description:
      "The geolocation coordinates for a line on the map. For more precision, it is possible that some values use *decimal* places.",
  })
