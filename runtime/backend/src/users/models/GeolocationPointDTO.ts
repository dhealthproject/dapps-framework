 ...
 * @since v0.3.2
 */
export class GeolocationPointDTO extends GeolocationDTO {
  /**
  ...
  @ApiProperty({
    ...
    example: [39, 56],
    description:
      "The geolocation coordinates for one point on the map. For more precision, it is possible that some values use *decimal* places.",
  })
