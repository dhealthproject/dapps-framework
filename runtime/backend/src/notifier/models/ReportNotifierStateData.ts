...
/**
 * @class ReportNotifierStateData
 * @description A type that represents data about the
 * state of the **report notifier** module. Note that we
 ...
 * @since v0.3.2
 */
export class ReportNotifierStateData implements StateData {
  /**
   * Contains the timestamp of the last execution of the
   * report notifier command.
   *
   * @access public
   * @var {number}
   */
