 ...
 * command with name: `notifier:ReportNotifier/W`.
 *
 * @since v0.5.3
 */
@Injectable()
export class WeeklyReportNotifier extends ReportNotifier {
  /**
   ...
   */
  @Cron("0 0 0 */7 * *", { name: `notifier:cronjobs:reportNotifier:W` })
