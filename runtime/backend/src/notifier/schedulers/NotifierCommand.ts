...
/**
 * @interface NotifierCommandOptions
 * @description This interface defines **arguments** that can be
 * passed to any **notifier** command that is implemented in the
 * backend runtime.
 * <br /><br />
 ...
 * @since v0.3.2
 */
export interface NotifierCommandOptions extends BaseCommandOptions {
  /**
 ...
 * *any* notifier commands. Note that notifier commands are always
 * stateful modules due to the extension of {@link StatefulModule}
 * in the parent class {@link BaseCommand}.
 * <br /><br />
 * Additionally, notifier command also *implement* the `CommandRunner`
 ...
 * @since v0.3.2
 */
export abstract class NotifierCommand extends BaseCommand {
  /**
   ...
   * @var {Scope}
   */
  protected scope: Scope = "notifier";

  /**
   * This method must be implemented by extending classes and
   * should report relevant subjects for this module.
   *
   * @abstract
   * @access public
   * @async
   ...
   */
  public abstract report(options?: NotifierCommandOptions): Promise<void>;
   ...
   * <br /><br />
   * The notifier collection can contain a mongo *collection*
   ...
   * notifier commands that extend this class. Child
   * classes must implement a {@link report} method
   ...
   *
   * @see BaseCommand
   * @param {NotifierCommandOptions}  options   The *parsed* runtime arguments passed to the command.
   * @returns {Promise<void>}
   */
  protected async runWithOptions(
    options: NotifierCommandOptions,
  ): Promise<void> {
